    ...
    <div class="block md:hidden mx-4">
        ...
        <div class="grid grid-cols-2 gap-3 mt-2">
            <router-link to="/class"
                class="bg-white rounded-lg shadow-sm p-3 flex items-center gap-3 cursor-pointer hover:shadow-md transition-shadow">
                <div
                    class="w-12 h-12 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 flex items-center justify-center text-white">
            ...
            <router-link to="/rank"
                class="bg-white rounded-lg shadow-sm p-3 flex items-center gap-3 cursor-pointer hover:shadow-md transition-shadow">
                <div
                    class="w-12 h-12 rounded-full bg-gradient-to-r from-orange-500 to-amber-500 flex items-center justify-center text-white">
            ...
            <div class="relative">
                ...
                <div class="flex justify-center mt-2 gap-1">
                    <span v-for="(book, index) in featuredBooks" :key="`featured-dot-${index}`"
                        @click="featuredCurrentIndex = index" class="w-2 h-2 rounded-full transition-all cursor-pointer"
        ...
        <section class="mb-6">
            ...
            <div class="space-y-3">
                <div v-for="(book, index) in hotBooks" :key="`recommend-${index}`"
                    class="flex gap-2 p-2 bg-white rounded-lg shadow-sm cursor-pointer"
                    @click="navigateToBook(book.id)">
        ...
        <section class="mb-6">
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                <ul class="divide-y divide-gray-200">
                    <li v-for="(item, index) in latestBooks" :key="index"
                        class="px-3 py-2 flex justify-between items-start cursor-pointer"
    ...
    <div class="hidden md:block container mx-auto px-4">
        ...
        <section class="my-10 w-5xl mx-auto">
            <div class="flex flex-col md:flex-row gap-6 md:items-start">
                <!-- 主推荐 -->
                <div v-if="currentBook" class="w-full md:w-2/3 bg-white rounded-xl shadow-sm overflow-hidden card-hover"
                    @click="navigateToBook(currentBook.id)">
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="w-full md:w-1/3 relative">
                            ...
                            <div v-if="mainBooks.length > 1" class="absolute top-0 right-0 flex flex-col">
                                <button v-for="(book, index) in mainBooks" :key="`thumb-${index}`"
                                    @mouseenter="setCurrentIndex(index)" @click.stop
                        ...
                        <div class="w-full md:w-2/3 p-6">
                            ...
                            <a href="#"
                                ...
                                @click.stop="navigateToBook(currentBook.id)">
                                开始阅读
                            </a>
                        </div>
                    </div>
                ...
                <div v-else
                    class="w-full md:w-2/3 bg-white rounded-xl shadow-sm overflow-hidden card-hover p-10 text-center">
                ...
                <div class="w-full md:w-2/3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div v-for="(book, index) in hotBooks" :key="index"
                            class="bg-white rounded-xl shadow-sm p-4 card-hover cursor-pointer"
                            @click="navigateToBook(book.id)">
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                        <div class="overflow-x-auto">
                            <table class="w-full min-w-max">
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in latestBooks" :key="index"
